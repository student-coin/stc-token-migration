              ...
              {!this.state.eula ? (
                <div>
                  <div className="App-eula">
                    <h2 className="App-header">STC Token v1 to v2 migration app</h2>
                    ...
                    <ol>
                      <li>
                        The swap will give you the same amount of STC Tokens v2 for all STC Tokens v1
                      </li>
                      <li>
                        The swap is mandatory and irreversible.
                      </li>
                      <li>
                        All of your STC v1 tokens need to be swapped - smaller swaps are disallowed.
                      </li>
                      <li>
                        While swapping, you will perform two transactions and pay a fee in ETH.
                      </li>
                      <li>When swapping more than 10 000 STC v1, you will receive a full/partial ETH gas refund for both transactions.</li>
                    </ol>

                    <p className="App-code-info">
                      The code of the STC Token v1 to v2 migration app could be reviewed at:
                      &nbsp;
                      <a
                          className="App-href"
                ...
                <div>
                  <div className="align-left mmt-2">
                    ...
                    <div className="line-height">
                      <p> Connected account: {this.state.address} </p>
                      <p>
